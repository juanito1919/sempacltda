...
@ManagedBean(name = "empresaextController")
@SessionScoped
public class EmpresaextController extends AbstractController<Empresa> implements Serializable {
