...
import ec.sempac.isw.negocio.AbstractFacade;
    ...
    public void destroy() {
        ...
        if (selected != null) {
            ...
            try {
                ...
                msg = ErrorException.getErrorPersistencia(ex);
                if (msg == null) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, null, ErrorException.getErrorException(ex));
